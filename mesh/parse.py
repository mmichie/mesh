...
if __name__ == "__main__":
    print simple_command.parseString('ls -al')
    print simple_command.parseString('ls | more')
    print simple_command.parseString('ls &') 
    print simple_command.parseString('ls > output') 
